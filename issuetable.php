...
<meta http-equiv="X-UA-Compatible" content="IE=edge,chrome=1" />
  ...
  $sql = mysql_query("SELECT books.*,isb.* FROM isb LEFT JOIN books on isb.bookid = books.id WHERE isb.isbstatus = 'Issued' order by isb.dateborrowed") or die (mysql_error());?>
    ...
    <div class="modal-content">
      ...
      <div class="modal-footer">
        ...
        <div class="right-side">
            <a href="returnbookprocess.php?id=<?php echo $row['id']?>" type="button" class="btn btn-success btn-simple">Yes</a>
        </div>
      </div>
    </div>
  </div>
