...
<!--                                  You can add classes for different colours on the next element -->
    ...
    "></li>
                                        <li class="active"><a href="removebooks.php" style="color:#000;"><i class="glyphicon glyphicon-remove-sign"></i> Remove Books</a></li>
...
<div class="alert alert-danger" role="alert" style="color:#FFF;"><span class="glyphicon glyphicon-cog"></span> Manage / Remove Books
...
<div class="container" style="height:400px;">
	<div class="row">
    <div class="col-lg-12">
<iframe src="rtable.php" height="400px;" width="100%" style="border:none;"></iframe>
</div></div></div>
