...
<!--                                  You can add classes for different colours on the next element -->
                                      <ul class="dropdown-menu dropdown-danger dropdown-menu-right">
                                        ...
                                        <li class="active"><a href="issueandsearchbooksUser.php" style="color:#000;"><i class="glyphicon glyphicon-search"></i> Issue/Search Books</a></li>
...
<!--                                  You can add classes for different colours on the next element -->
                                      <ul class="dropdown-menu dropdown-danger dropdown-menu-right">
                                        ...
                                        <li><a href="account_profileUser.php" style="color:#000;"><i class="glyphicon glyphicon-cog"></i> Profile</a></li>
...
<iframe src="isbtableUser.php" height="400px;" width="100%" style="border:none;"></iframe>
</div>
