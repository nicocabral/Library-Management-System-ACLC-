...
<!--                                  You can add classes for different colours on the next element -->
    ...
    "></li>
                                      ...
                                      <li class="active"><a href="userlist.php" style="color:#000;"><i class="glyphicon glyphicon-user"></i> User</a></li>
...
<div class="alert alert-danger" role="alert" style="color:#FFF;"><span class="glyphicon glyphicon-user"></span> Account / Userlist
...
<iframe src="userlistTable.php" height="400px;" width="100%" style="border:none;"></iframe>
</div>
