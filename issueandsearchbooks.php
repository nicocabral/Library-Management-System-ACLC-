...
<!--                                  You can add classes for different colours on the next element -->
                                      <ul class="dropdown-menu dropdown-danger dropdown-menu-right">
                                        ...
                                        <li class="active"><a href="issueandsearchbooks.php" style="color:#000;"><i class="glyphicon glyphicon-search"></i> Issue/Search Books</a></li>
...
<iframe src="isbtable.php" height="400px;" width="100%" style="border:none;"></iframe>
</div>
