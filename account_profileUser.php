<?php session_start();
if(isset($_SESSION['username']) && isset($_SESSION['password']) && $_SESSION['user_type']=='user'){?>
<!doctype html>
<html lang="en">
...
<!--                                  You can add classes for different colours on the next element -->
                                      <ul class="dropdown-menu dropdown-danger dropdown-menu-right">
                                        ...
                                        <li><a href="issueandsearchbooksUser.php" style="color:#000;"><i class="glyphicon glyphicon-search"></i> Issue/Search Books</a></li>
                                        <li><a href="returnbooksUser.php" style="color:#000;"><i class="glyphicon glyphicon-repeat"></i> Return Books</a></li>
...
<!--                                  You can add classes for different colours on the next element -->
                                      <ul class="dropdown-menu dropdown-danger dropdown-menu-right">
                                        ...
                                        <li class="active"><a href="account_profileUser.php" style="color:#000;"><i class="glyphicon glyphicon-cog"></i> Profile</a></li>
...
<div class="row">
  ...
  <?php }}?>
  <form style="margin-top:5px;" action="updateavatar-User.php" method="post" enctype="multipart/form-data">
...
<div class="modal fade bs-example-modal-lg" id="updateModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
  <div class="modal-dialog modal-lg">
    ...
    <?php include('includes/dbconn.php');
		 $id = $_SESSION['id'];
  $query = mysql_query("SELECT * FROM user  WHERE id = '$id'") or die (mysql_error()); ?>
      <form class="form-horizontal" action="account_profileUser.php" method="post">
  ...
  <div class="col-lg-6">
    ...
    <div class="col-sm-10 has-warning">
       <input type="text" name="type" value="<?php echo $row['usertype']?>" readonly>
    </div>
...
?>
 ...
 <?php include('changepasword-User.php')?>
</body>
